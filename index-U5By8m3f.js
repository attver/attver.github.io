...
function xo(e, n, t, r) {
  ...
  typeof o == "object" && o !== null
    ? (l.context = xe(o))
    : ((o = de(n) ? _n : re.current), (l.context = qn(e, o))),
...
function ad(e, n, t) {
  ...
  switch ((uu(n), n.tag)) {
    ...
    case 4:
      return (
        nt(), To(e, n), e === null && $t(n.stateNode.containerInfo), ne(n), null
      );
    case 10:
...
function Ha(e, n, t) {
  for (var r = (e.mode & 1) !== 0; S !== null; ) {
    ...
    if (l.tag === 22 && r) {
      ...
      l.subtreeFlags & 8772 && o !== null ? ((o.return = l), (S = o)) : Ii(e);
  }
}
function Ii(e) {
  for (; S !== null; ) {
          ...
          children: [
            ...
            le.jsxs("div", {
              children: [
                le.jsx("button", {
                  className:
                    "bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded mr-4",
                  style: { fontSize: l },
                  onClick: () => r(!0),
                  children: "Yes",
                }),
...
Ql.createRoot(document.getElementById("root")).render(
  le.jsx(wc.StrictMode, { children: le.jsx(Od, {}) })
);
